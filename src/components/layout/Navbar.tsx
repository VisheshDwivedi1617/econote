...
const Navbar = () => {
  ...
  return (
    <nav className="flex justify-between items-center border-b border-gray-200 px-6 py-4 bg-white">
      <div className="flex items-center space-x-2">
        <Pen className="h-6 w-6 text-pen-primary" />
        <span className="text-xl font-semibold text-pen-dark">ScribeSync</span>
      </div>
